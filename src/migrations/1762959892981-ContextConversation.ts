...
export class ContextConversation1762959892981 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Conversation\` ADD CONSTRAINT \`FK_b98f5ed120cc0c768c3b40d9434\` FOREIGN KEY (\`id-tesis\`) REFERENCES \`tesis\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`Conversation\` DROP FOREIGN KEY \`FK_b98f5ed120cc0c768c3b40d9434\``);
